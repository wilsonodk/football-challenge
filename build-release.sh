...
echo "Create tarball"
tar cvfz $RELEASE --exclude="^*.tar.gz" --exclude=build-release.sh --exclude=football-challenge.sql --exclude=junkies-out.sql --exclude=deploy-release.sh --exclude=.DS_Store --exclude=.git --exclude=.gitignore --exclude=.editorconfig .
echo "Finished..."
